...
<section class="page">
    <form class="form-box auth" action="get">
        ...
        <div class="auth-switch">Chưa có tài khoản? <a class="text-link" href="<?= url('/register') ?>">Tạo tài
                khoản</a>
        </div>
    </form>
</section>
...
<form action="<?= url('/login/mock') ?>" method="post">
    <button type="submit" class="btn"
        style="width: 100%; background: #4caf50; color: #fff; padding: 10px; border-radius: 4px; border: none; cursor: pointer;">
